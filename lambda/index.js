...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Bem-vindo, você ouvirá sena rock!';

        return handlerInput.responseBuilder
            .speak(speakOutput)
            .addAudioPlayerPlayDirective('REPLACE_ALL', 'https://stream-151.zeno.fm/zj3bppkwxvktv?zs=OkjToEZpQfOD9x5S87lExA', 1, 0, null, null)
            .getResponse();
    }
};
/**
 ...
 * */
const EstúdioBalaIntentHandler = {
    canHandle(handlerInput) {
    ...
    async handle(handlerInput) {
        ...
        const speakOutput = 'Reproduzindo o Sena FM.';
        const playBehavior = 'REPLACE_ALL';
        const podcastUrl = 'https://stream-151.zeno.fm/zj3bppkwxvktv?zs=OkjToEZpQfOD9x5S87lExA';
